...
Route::middleware('admin')->group(function () {
    Route::get('/admin/promotions/create', [PromotionsController::class, 'create'])->name('promotions.create');
    Route::post('/admin/promotions', [PromotionsController::class, 'store'])->name('promotions.store');
    Route::get('/admin/promotions/{promotion}/edit', [PromotionsController::class, 'edit'])->name('promotions.edit');
    Route::put('/admin/promotions/{promotion}', [PromotionsController::class, 'update'])->name('promotions.update');
    Route::delete('/admin/promotions/{promotion}', [PromotionsController::class, 'destroy'])->name('promotions.destroy');

    Route::resource('/dashboard/sales', AdminSalesController::class)->except(['show']);
    Route::resource('/dashboard/orders', AdminOrderController::class)->except(['show']);
    Route::resource('/dashboard/customers', AdminCustomer::class)->except(['show']);
});
