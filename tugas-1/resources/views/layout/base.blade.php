        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="/img/FOTO DIRI.jpeg" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">{{ session('user_name','Aulia Putri Salsabila') }}</a>
                    </div>
                </div>
          ...
          <li data-pertemuan="1" class="nav-item has-treeview {{ request()->is('pertemuan1/*') ? 'menu-open' : '' }} ">
            ...
            <ul class="nav nav-treeview">            
              ...
              <li class="nav-item">
                    <a href="{{ route('basic') }}" class="nav-link {{ request()->is('basic*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Basic Routing</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('named') }}" class="nav-link {{ request()->is('named*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon"></i>
                           <p>Named Routes</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('fallback') }}" class="nav-link {{ request()->is('fallback*') ? 'active' : '' }}">
                        <i class="far fa-circle nav-icon"></i>
                            <p>Fallback Routes</p>
                    </a>
                </li>
